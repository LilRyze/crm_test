...
<h2 class="col-sm-2 offset-1">Edit Tour</h2>

<form method="post" action="/edit_tour" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="form-group row">
        <label for="country_to_change" class="col-sm-1 offset-1 col-form-label">What country of tour change?</label>
        <div class="col-sm-6">
            <input name="country_to_change" type="text" class="form-control" id="country_to_change" placeholder="country_to_change">
        </div>
    </div>
    <div class="form-group row">
